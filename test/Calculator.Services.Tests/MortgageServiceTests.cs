...
namespace Calculator.Services.Tests
{
	...
	public class MortgageServiceTests
    {
        ...
        //[Theory]
        //[InlineData(1000, 2, 0, PaymentFrequency.Monthly, 10, 73.29, 1073.29)]
        //public void ExtraPaymentCalculateLoan_ValidInput_ShouldSucceed(double mortgageAmount,
        //     int years,
        //     int months,
        //     PaymentFrequency paymentFrequency,
        //     double interestRate,
        ...
        [Theory]
        [InlineData(1000, 2, 0, PaymentFrequency.Monthly, 10, 46.14, 4.48, 107.48, 1107.48)]
        public void CalculateLoan_ValidInput_ShouldSucceed(double mortgageAmount,
             int years,
             int months,
             PaymentFrequency paymentFrequency,
